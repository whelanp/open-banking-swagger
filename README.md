...
#### API Docs
Our API specification is available at the following link. [Click here for the API documentation](https://whelanp.github.io/open-banking-swagger/docs/redoc.html). 
